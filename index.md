...
Temporal CCA, applied independently at each time bin with cross-validation, is robust to temporal misalignments from spike sorting and circuit-specific timescales, ensuring regional differences in coupling reflect genuine interhemispheric coordination rather than biophysical confounds. All 39 regions showed coupling above permutation null, ranging from r = 0.25 (VISpm2/3) to r = 0.96 (SUB) <p align="center">
  <img src="figures/Figure_1. Top 15 brain regions ranked by bilateral coupling strength.png" width="600"/>
</p>
