...
## 3.2 Coupling strength and choice encoding are organized by distinct spatial gradients. 

Peak coupling and peak choice encoding |r_choice| were uncorrelated across regions (Spearman ρ = −0.21, p = 0.17; Figure 3). 
<p align="center">
...
The Swanson flatmap visualizes this dissociation (Figure 4): coupling is dominated by hippocampal and midbrain structures, while choice encoding concentrates in prefrontal and posterior thalamic regions, paralleling the selective shared subspace of Semedo et al. (2019, Neuron) extended to the bilateral context.
<p align="center">
...
Bilateral coupling was sustained across the trial in motor, hippocampal, and midbrain regions, with phase-dependent modulation in visual and thalamic regions (Figure 6).
<p align="center">
